...
## Code
To access the Notebooks for this course you can either click the green "code" button (top right corner) and "Download Zip," or you can "clone" the repository onto your computer over terminal with the following command:
